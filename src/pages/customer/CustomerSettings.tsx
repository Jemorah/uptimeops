    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-surface border border-white/5 p-6 space-y-4">
        ...
        <div className="grid gap-4">
          <div>
            ...
            <Input defaultValue="John Doe" className="bg-elevated border-white/10 text-white" />
          </div>
          <div>
            <label className="block text-xs text-white/40 mb-2">Email</label>
            <Input defaultValue="john@acme-corp.com" className="bg-elevated border-white/10 text-white" />
          </div>
          <div>
            <label className="block text-xs text-white/40 mb-2">Company</label>
            <Input defaultValue="Acme Corp" className="bg-elevated border-white/10 text-white" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-surface border border-white/5 p-6 space-y-4">
        ...
        <div className="space-y-4">
          {[
            ...
            { key: 'sms', label: 'SMS Alerts', desc: 'Critical incidents only via SMS', icon: Bell },
      ...
      <div className="bg-surface border border-white/5 p-6 space-y-4">
        ...
        <div className="space-y-3">
          <button className="w-full text-left px-4 py-3 border border-white/10 text-sm hover:border-lime transition-colors">
            Change Password
          </button>
          <button className="w-full text-left px-4 py-3 border border-white/10 text-sm hover:border-lime transition-colors">
      ...
      <button onClick={handleSave} className="btn-lime text-sm rounded-sm">
        Save Changes
      </button>
    </div>
  );
